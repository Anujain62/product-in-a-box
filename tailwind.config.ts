  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        success: "hsl(var(--success))", warning: "hsl(var(--warning))", info: "hsl(var(--info))", error: "hsl(var(--error))",
        dsa: "hsl(var(--dsa))", "system-design": "hsl(var(--system-design))", lld: "hsl(var(--lld))",
        os: "hsl(var(--os))", cn: "hsl(var(--cn))", dbms: "hsl(var(--dbms))", aiml: "hsl(var(--aiml))",
